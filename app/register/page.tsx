      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="w-full max-w-md bg-white border border-[#CCCCCC] rounded-lg p-8">
          <div className="mb-8 text-center">
            <h1 className="text-2xl font-bold text-[#222222] mb-2">Create Account</h1>
            <p className="text-xs text-gray-500 font-bold uppercase tracking-widest">Join the task network</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label className="block text-xs font-bold text-[#444444] uppercase mb-1 tracking-wide">Full Name</label>
              <input 
                type="text" 
                required
          ...
          <div className="mt-6 text-center text-xs font-bold text-gray-500">
            ...
            <Link href="/login" className="text-[#0079B8] hover:underline uppercase tracking-wide">
              Sign In
            </Link>
          </div>
        </div>
